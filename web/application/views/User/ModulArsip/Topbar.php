        ...
        <aside class="sidebar">
            ...
            <nav class="navs">
                <ul class="navs__list list-unstyled">
                    ...
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulRapatUser") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul Rapat"><img src="<?php echo base_url("assets/img/icons/pemesanan_ruangan_rapat.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulATKUser") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul ATK"><img src="<?php echo base_url("assets/img/icons/atk.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulFasilitasUser") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul Fasilitas"><img src="<?php echo base_url("assets/img/icons/perbaikan_fasilitas.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulArsipUser") ?>" class="active" data-toggle="tooltip" data-placement="bottom" title="Modul Arsip"><img src="<?php echo base_url("assets/img/icons/arsip.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
