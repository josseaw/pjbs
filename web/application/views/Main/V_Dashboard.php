...
<head>
    ...
    <title>PJBS Web App | Dashboard Admin </title>
                ...
                <div class="board">
                    <div class="d-flex flex-row">
                        <div class="pemesanan-kendaraan m-w-782 bg-white">
                            ...
                            <a href="<?= base_url('ModulKendaraan/Sopir') ?>">Lihat data pemesanan ></a>
                        </div>
                        <div class="pemesanan-kendaraan m-w-315 m-20 bg-gradient-blue">
                            <p class="text-white">Pelayanan Sopir</p>
                            <div id="pelayanan">
                            </div>
                            <a href="<?= base_url('ModulKendaraan/Riwayat') ?>" class="text-white">Lihat data sopir ></a>
                        </div>
                    </div>
                </div>
            </div>
