        ...
        <aside class="sidebar">
            ...
            <nav class="navs">
                <ul class="navs__list list-unstyled">
                    ...
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulRapatManajer") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul Rapat"><img src="<?php echo base_url("assets/img/icons/pemesanan_ruangan_rapat.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulATKManajer") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul ATK"><img src="<?php echo base_url("assets/img/icons/atk.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulFasilitasManajer") ?>" data-toggle="tooltip" data-placement="bottom" title="Modul Fasilitas"><img src="<?php echo base_url("assets/img/icons/perbaikan_fasilitas.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulArsipManajer") ?>" class="active" data-toggle="tooltip" data-placement="bottom" title="Modul Arsip"><img src="<?php echo base_url("assets/img/icons/arsip.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
                                    ...
                                    <div class="dropdown-menu jos" aria-labelledby="dropdownMenuReference">
                                        ...
                                        <div class="dropdown-list">
                                            <div class="scroll" id="isi-notifikasi">
                                                ...
                                                <a class="notifikasi_detail"> <div class="list-drop bg-blue-rgba"> <div class="img-notifikasi bg-white" style="margin-bottom:10px;margin-top:10px;"> <img src="<?= base_url('')?>assets/img/icons/folder_biru.png" alt=""> </div> <div class="content-notifikasi" style="font-size:12px;width:100%"> <p>Arsip Anda sudah masuk rak</p> <p> 10:00 WIB</p> </div> </div> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
