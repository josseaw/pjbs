<!-- MAIN -->
        <div class="content">
            <div class="col-12">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link text-center active" href="<?= base_url('ModulArsipManajer')?>">Pesan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center" href="<?= base_url('ModulArsipManajer/CariArsip')?>">Cari Arsip</a>
                    </li>
                </ul>
        ...
        <div class="from-modal collapse" id="multiCollapseExample2">
            <div class="row">
                ...
                <div class="from sunting" data-toggle="modal" data-target="#modalSuntingSopir"><span class="img-from"><img src="../<?= base_url('') ?>assets/img/icons/edit.png" alt=""></span>
                    <h4>Sunting</h4>
                </div>
                <div class="from hapus" data-toggle="modal" data-target="#multiHapus"><span class="img-from"><img src="../<?= base_url('') ?>assets/img/icons/hapus.png" alt=""></span>
                    <h4>Hapus</h4>
