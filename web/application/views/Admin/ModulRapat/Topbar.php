        ...
        <aside class="sidebar">
            ...
            <nav class="navs">
                <ul class="navs__list list-unstyled">
                    ...
                    <li class="navs__list-item">
                        <a href="<?php echo base_url("ModulRapat") ?>" class="active" data-toggle="tooltip" data-placement="bottom" title="Modul Rapat"><img src="<?php echo base_url("assets/img/icons/pemesanan_ruangan_rapat.png") ?>" class="icn_menu" /></a>
                    </li>
                    <li class="navs__list-item">
